...
/// @author sm-sc
///
/// @brief SCBL for SCR1 on VCU118

#ifndef PLATFORM_VCU118_SCR1_CONFIG_H
#define PLATFORM_VCU118_SCR1_CONFIG_H
...
#if __riscv_xlen != 32
#error RV32 platform, do not use RV64=1 for build
#endif
...
#endif // PLATFORM_VCU118_SCR1_CONFIG_H
