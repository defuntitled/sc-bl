...
#ifndef PLATFORM_HTG960_SCR7_L2_PMP_CONFIG_H
#define PLATFORM_HTG960_SCR7_L2_PMP_CONFIG_H
...
#define PLF_CMEM_SIZE   (64*1024*1024)
#define PLF_CMEM_BASE   (PLF_MEM_BASE + PLF_MEM_SIZE - PLF_CMEM_SIZE)
#define PLF_CMEM_ATTR   (SCR_PMP_CTRL_MT_STRONG | PMP_R | PMP_W)
...
#define PLF_MMIO_ATTR   (SCR_PMP_CTRL_MT_STRONG | PMP_R | PMP_W)
#define PLF_MMIO_NAME   "MMIO"

#define PLF_PLIC_BASE   EXPAND32ADDR(0xfe000000)
#define PLF_PLIC_SIZE   (16*1024*1024)
#define PLF_PLIC_ATTR   (SCR_PMP_CTRL_MT_STRONG | PMP_R | PMP_W)
...
#define PLF_NVRAM_KERNEL_BASE (0x0)
#define PLF_NVRAM_KERNEL_SIZE (64*1024*1024)
#define PLF_NVRAM_CHIPSELECT  (0x2)
...
#endif // PLATFORM_HTG960_SCR7_L2_PMP_CONFIG_H
